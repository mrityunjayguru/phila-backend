...
class RegisterController extends CommonController
{
    ...
    */
    ...
    public function register(Request $request)
    {
		...
		{
			// USER REGISTER
			$user = User::create(['email'=>$request->email, 'name'=>$request->name, 'phone_number'=>$request->phone_number, 'user_type'=>'Customer', 'email_verified_at'=>date('Y-m-d h:i:s'), 'password'=>Hash::make($request->password)]);
