...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password','phone_number','user_type','status','is_subscribed','added_by_id','profile_image','country_code','dob','gender','noti_via_nitification','noti_via_email','vendor_approved','verified_at',
    ];
