	...
	<div class="main-card mb-3 card">
		<div class="card-header-tab card-header">
			...
			<div class="btn-actions-pane-right text-capitalize">
				...
				<a class="btn-wide btn-outline-2x mr-md-2 btn btn-outline-focus btn-sm" href="{{ route('tickets.create') }}" > {{trans('common.add_new')}} </a>
				@endif
			</div>
		</div>
		<div class="card-body">
...
<script>
	...
	function getData(page = 1){
		...
		var response = adminAjax('{{route("ajax.ticket.list")}}', data); 
	...
	function deleteThis(item_id = ''){
		if(confirm("{{trans('common.delete_confirm')}}")){
			...
			var response = adminAjax('{{route("ajax.delete.ticket")}}', data);
			if(response.status == '200'){
