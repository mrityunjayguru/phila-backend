		...
		<div class="card-body">
			<form class="" action="javascript:void(0);" onsubmit="saveData()" enctype="multipart/form-data">
				<div class="form-row">
					<div class="col-md-4">
						...
						<div class="position-relative form-group">
							...
							<input type="text" id="ticket_number" placeholder="Enter Code number" class="form-control">
				...
				<!--<div class="form-row">
					<div class="col-md-3">
						<div class="position-relative form-group">
							...
							<input type="text" id="customer_name" placeholder="Enter Customer Name" class="form-control">
					...
					<div class="col-md-3">
						<div class="position-relative form-group">
							...
							<input type="number" id="customer_number" placeholder="Enter contact number" class="form-control">
				...
				<div class="form-row">
					<!--<div class="col-md-3">
						<div class="position-relative form-group">
							<label for="bus">Device / Bus</label>
							<select  class="form-control" minlength="2" maxlength="255" id="bus">
		                      <option value="">Select</option>
		                      @foreach($buses as $list)
							  <option value="{{$list->id}}">{{$list->title}}</option>
							  @endforeach
							</select>
							<div class="validation-div" id="val-bus"></div>
						</div>
					</div>-->
					<div class="col-md-3">
						<div class="position-relative form-group">
...
@section('js')
	<script>
		...
		function saveData(){
			...
			var response = adminAjax('{{route("codes.store")}}', data);
			if(response.status == '200'){
				swal.fire({ type: 'success', title: response.message, showConfirmButton: false, timer: 1500 });
				setTimeout(function(){ window.location.href = "{{route('codes.index',$page_id)}}" }, 2000);
