        ...
        <div class="page-title-heading">
            <div>
                <div class="page-title-head center-elem">
                    ...
                    <span class="d-inline-block">{{ trans($type.'.add') }}</span>
                </div>
            </div>
        </div>
                ...
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"> <a
                                href="{{ route('page.places',[$type]) }}">{{ trans($type.'.singular') }}</a></li>
                        <li class="active breadcrumb-item" aria-current="page">{{ trans($type.'.add') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4">
                            <div class="position-relative form-group">
                                ...
                                <input type="text" id="latitude" placeholder="" class="form-control">
                        ...
                        <div class="col-md-4">
                            <div class="position-relative form-group">
                                ...
                                <input type="text" id="longitude" placeholder="" class="form-control">
                                <div class="validation-div" id="val-longitude"></div>
                            </div>
                        </div>
						<div class="col-md-10">
							<div class="position-relative form-group">
								<label for="google_business_url" class="">Google Business URL</label>
								<input type="text" id="google_business_url" placeholder="Enter Google Business URL" class="form-control">
					...
					<div class="form-row">
                        <div class="col-md-5">
                            <div class="position-relative form-group">
                                ...
                                <input type="text" id="website" placeholder="Enter URL" class="form-control">
                    ...
                    <div class="form-row">
                        <div class="col-md-12">
							...
							<label class="dasdads toggleSwitch" onclick="">
								<input name="hours" type="checkbox" checked>
								<span><span>OFF</span><span>ON</span></span>
								<a></a>
							</label>
						</div>
                        <div class="hours-box col-md-12">
							<table>
								@foreach($days as $day)
								<tr class="tr-10">
                    ...
                    <div class="form-row">
                        <div class="col-md-12">
							<b>Entry Charges</b>
							<label class="dasdads toggleSwitch" onclick="">
								<input name="charges" type="checkbox" checked>
								<span><span>OFF</span><span>ON</span></span>
								<a></a>
							</label>
						</div>
                        <div class="col-md-8">
							<hr>
                            <div class="charges-box position-relative form-group">
                                <textarea id="charges" rows="4" class="form-control"></textarea>
						...
						<div class="col-md-8">
                            <div class="position-relative form-group">
                                ...
                                <input type="text" id="ticket_booking_url" placeholder="Enter URL" class="form-control">
                    ...
                    <div class="form-row">
                        <div class="col-md-12">
                            <div class="position-relative form-group">
                                ...
                                <div class="image-preview"><img id="image-src" src="" width="50%" /></div>
...
<!-- CONTENT OVER -->
<script src="https://maps.googleapis.com/maps/api/js?key={{Settings::get('google_map_api_key')}}&callback=initMap&v=3.exp&sensor=false&libraries=places" async></script>
@endsection
...
function saveData() {
    ...
    if (response.status == '200') {
        ...
        setTimeout(function() {
            window.location.href = "{{ route('page.places',[$type]) }}";
        }, 2000)
