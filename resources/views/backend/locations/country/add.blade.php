...
@section('content')
				...
				<div class="page-title-heading">
					<div>
						<div class="page-title-head center-elem">
							...
							<span class="d-inline-block">{{ trans('country.add') }}</span>
						</div>
					</div>
				</div>
					...
					<div class="page-title-subheading opacity-10">
						<nav class="" aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="active breadcrumb-item" aria-current="page">Add</li>
							</ol>
						</nav>
					</div>
				</div>
	...
	<div class="main-card mb-3 card">
		<div class="card-body">
			<form action="javascript:void(0);" id="add_country_form" enctype="multipart/form-data">
				<div class="form-row">
					...
					<div class="col-md-3">
						<div class="position-relative form-group">
							...
							<input id="dial_code" name="dial_code" type="text"  class="form-control">
							<div class="validation-div" id="val-price"></div>
						</div>
					</div>
					<div class="col-md-3">
...
<script>
	$('#add_country_form').submit(function (e){
		...
		formData.append('filter_section', 'add_section');
