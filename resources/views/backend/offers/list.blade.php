						...
						<div class="col-md-12">
							...
							<div class="position-relative form-group">
								<div>
									...
									<div class="custom-radio custom-control">
										<input type="radio" id="expired" value="expired" name="statusRadio" class="custom-control-input">
...
@section('content')
			...
			<div class="page-title-heading">
				<div>
					<div class="page-title-head center-elem">
						...
						<span class="d-inline-block">Offer</span>
					</div>
				</div>
			</div>
				...
				<div class="page-title-subheading opacity-10">
					<nav class="" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"> <a>Offers</a></li>
						</ol>
					</nav>
				</div>
			</div>
	...
	<div class="main-card mb-3 card">
		<div class="card-header-tab card-header">
			<div class="card-header-title font-size-lg text-capitalize font-weight-normal">Offer List</div>
			<div class="btn-actions-pane-right text-capitalize">
				...
				<a class="btn-wide btn-outline-2x mr-md-2 btn btn-outline-focus btn-sm" href="{{ route('offers.create') }}" > Add New</a>
				@endif
			</div>
		</div>
		<div class="card-body">
