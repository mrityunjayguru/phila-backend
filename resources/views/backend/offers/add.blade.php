	...
	<div class="main-card mb-3 card">
		<div class="card-body">
			<form class="" action="javascript:void(0);" onsubmit="saveCoupon()"  enctype="multipart/form-data">
						...
						<div class="form-row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<input type="text" id="start_date" placeholder="Enter Start Date" class="form-control" value="" autocomplete="off" data-toggle="datepicker">
							...
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<input type="text" id="end_date" placeholder="Enter End Date" class="form-control" value="" autocomplete="off" data-toggle="datepicker">
				...
				<div class="form-row">
					@if(Settings::UserPermission('offer-create'))
...
<script>
	...
	function saveCoupon(){
		...
		//data.append('mon_sat', $('#mon_sat').val());
		//data.append('sunnday', $('#sunnday').val());
		//data.append('adult_charges', $('#adult_charges').val());
		//data.append('student_charges', $('#student_charges').val());
