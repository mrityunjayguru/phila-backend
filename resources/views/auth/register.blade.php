                                ...
                                <form class="ai-signup" action="javascript:void(0);" method="POST" onsubmit="registerUsers();">
                                  @csrf
									...
									<div class="form-row">	
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="phone_number" id="phone_number" placeholder="Phone Number here..." type="text" class="form-control">
                                    ...
                                    <div class="mt-3 position-relative form-check">
                                        ...
                                        <label for="exampleCheck" class="form-check-label">Accept our <a class="text-theme" href="{{ url('terms') }}" target="_blank">Terms and Conditions</a>.</label>
                                    </div>
